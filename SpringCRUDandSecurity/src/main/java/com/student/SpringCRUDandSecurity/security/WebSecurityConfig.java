...
import com.student.SpringCRUDandSecurity.service.UserDetailsServiceImpl;
	 ...
	 @Bean
	    ...
	    protected void configure(HttpSecurity http) throws Exception {
	        http.authorizeRequests()
	            .antMatchers("/","/students/save","/students/saveForm","/students/403").hasAnyAuthority("USER","ADMIN")
